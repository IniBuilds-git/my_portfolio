...
export default function Hero() {
  return (
    <section className="w-full max-w-[1400px] mx-auto px-8 md:px-16 pt-16 pb-10">
      <motion.div
      ...
      >
        <div className="flex-1 max-w-[800px]">
          <div className="flex items-center gap-3 mb-6">
            <h1 className="text-[22px] font-normal text-white">Hey, I'm Inioluwa</h1>
            <span className="text-base">🌙</span>
          </div>

          <p className="text-[14px] leading-[1.6] text-zinc-400">
            Software Engineer & AI Builder with 3+ years experience building backend systems, cloud infrastructure, and intelligent automation for scalable products. Currently building{" "}
            <span className="text-white underline decoration-zinc-700 hover:decoration-zinc-500 transition-colors cursor-pointer">
              CarRecovery
            </span>{" "}
            and{" "}
            <span className="text-white underline decoration-zinc-700 hover:decoration-zinc-500 transition-colors cursor-pointer">
